...
export class SimpleFace {
  ...
  setTime(time) {
    this._hourHand.position = ClockUtilties.getHourHandPositionInRadians(time);
    this._minuteHand.position = ClockUtilties.getMinuteHandPositionInRadians(time);
    this._secondHand.position = ClockUtilties.getSecondHandPositionInRadians(time);
  }
}