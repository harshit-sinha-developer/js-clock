...
var ClockApp = exports.ClockApp = function () {
    ...
    _createClass(ClockApp, [{
        ...
        value: function _getCanvas(canvasWidth, canvasHeight) {
            return (0, _jquery2.default)("<canvas width=\"" + canvasWidth + "\" height=\"" + canvasHeight + "\"></canvas>");
        }
    }, {
        key: "_getClockContainerEle",
        value: function _getClockContainerEle() {
            return (0, _jquery2.default)('<div class="jq-clock"></div>');
        }
    }, {
        key: "_getTimeHrMmSs",
        value: function _getTimeHrMmSs(date) {
...
var SimpleFace = exports.SimpleFace = function () {
